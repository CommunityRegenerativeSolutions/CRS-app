...
function generateClientIntakePdf(submission) {
  console.info("CRS client intake: Generating PDF locally.");
...
form.addEventListener("submit", async (event) => {
  ...
  setSubmitting(true);
  showStatus("Generating intake PDF...", "info");

  try {
    generateClientIntakePdf(collectSubmission());
    form.hidden = true;
