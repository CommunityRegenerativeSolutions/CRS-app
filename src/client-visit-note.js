...
function generateClientVisitNotePdf(submission) {
  console.info("CRS visit note: Generating PDF locally.");
...
form.addEventListener("submit", async (event) => {
  ...
  setSubmitting(true);
  showStatus("Generating visit note PDF...", "info");

  try {
    generateClientVisitNotePdf(collectSubmission());
    form.hidden = true;
