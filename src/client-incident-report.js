...
function generateClientIncidentReportPdf(submission) {
  console.info("CRS incident report: Generating PDF locally.");
...
form.addEventListener("submit", async (event) => {
  ...
  setSubmitting(true);
  showStatus("Generating incident report PDF...", "info");

  try {
    generateClientIncidentReportPdf(collectSubmission());
    form.hidden = true;
